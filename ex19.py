...
The priority is that name > age > score. If the following tuples are given as input to the program: Tom,19,80 John,20,90 Jony,17,91 Jony,17,93 Json,21,85 
...
ip_ls = [str(x) for x in input("Enter Tuples:").split()]
#ip_tp = [tuple(x) for x in ip_ls]
